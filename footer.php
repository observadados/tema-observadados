...
<a class="btn-top page-scroll" href="#page" aria-label="Voltar ao topo da página"><i class="fas fa-angle-up"></i>
	<span>Topo</span></a>
			...
			<div class="row">
				<div class="col logo-container">
					<div>
						...
						if ($logo_rodape)
							echo '<a href="' . home_url() . '" aria-label="Voltar para a página inicial"><figure class="logo-footer"><img src="' . esc_url($logo_rodape['url']) . '" alt="' . esc_attr(get_bloginfo('name')) . '"></figure></a>';
						if ($conteudo_rodape)
							echo '<div>' . nl2br($conteudo_rodape) . '</div>';
						?>
