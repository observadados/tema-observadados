	...
	<div class="page-row">
			...
			<div class="dataset-file-list">
				<?php if ($files): ?>
					...
					<div class="dataset-file-item">
						...
						<div class="file-action" style="display:flex; gap:.5rem;">
							<?php if ($is_previewable): ?>
								<button class="btn btn-preview" data-url="<?php echo esc_url($url); ?>" style="background:#eee; color:#333;"><i class="fa-solid fa-eye"></i> Visualizar</button>
							<?php endif; ?>
							<a href="<?php echo esc_url($download_url); ?>" class="btn"><i class="fa-solid fa-download"></i> Baixar</a>
						</div>
					</div>
					<?php endforeach; ?>
				<?php else: ?>
		...
		<aside class="dataset-files">
			...
			<ul class="dataset-summary-list">
				<li><i class="fa-regular fa-folder-open"></i> <strong><?php echo count($files); ?> arquivos</strong></li>
				...
				<?php endif; ?>
				<li><i class="fa-solid fa-database"></i> <strong>Tamanho Total:</strong> <?php echo esc_html($tamanho_formatado); ?></li>
